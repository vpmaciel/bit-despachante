...
final class UsuarioControl {
	...
	public class MostraFrameConta extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent event) {
			if (event.getButton() == MouseEvent.BUTTON1) {
				...
				MainControl.getUsuarioJan().reiniciarGui();
			}
		}
	}
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			totalPesquisaRegistro = MainControl.getUsuarioJan().getUsuarioPainelPesq().pesquisarRegistro(usuario);
			Msg.avisoRegistroEncontrado(totalPesquisaRegistro);

			if (totalPesquisaRegistro > 0) {
				MainControl.getUsuarioJan().getTabbedPane().setSelectedIndex(1);
			}
		}
	}
	...
	public class Registro implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			totalPesquisaRegistro = MainControl.getUsuarioJan().getUsuarioPainelPesq().pesquisarRegistro(new Usuario());
			Msg.avisoRegistroEncontrado(totalPesquisaRegistro);
		...
		public void actionPerformed(ActionEvent actionEvent) {
			try {
				...
				if (mensagem == JOptionPane.YES_OPTION) {
					...
					usuario = new Usuario();
					MainControl.getUsuarioJan().limparGui();
	...
	public UsuarioJan getCienteJanCad() {
		return MainControl.getUsuarioJan();
	}

	public UsuarioPainelCad getUsuarioPainelCad() {
		return MainControl.getUsuarioJan().getUsuarioPainelCad();
	}
