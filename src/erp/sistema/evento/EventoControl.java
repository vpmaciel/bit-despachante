...
final class EventoControl {
	...
	public class Exclui implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			if ((evento == null) || (evento.getId() == null) || (Msg.confirmarExcluiRegistro() != JOptionPane.YES_OPTION)) {
				return;
			}
			try {
	...
	public void atualizarGui() {
		...
		getEventoPainelCad().getTipoEventoGui().setText(evento.getTipoEvento());
	...
	public void atualizarObjeto() {
		...
		evento.setTipoEvento(getEventoPainelCad().getTipoEventoGui().getText());
	}
