...
public final class DadosJanCad extends JFrame implements Gui {

	private ConfiguracaoGui configuracaoGui;
	private DadosControl contadorControl;
	private DadosPainelCad contadorPainelCad;
	...
	public DadosControl getDadosCont() {
	...
	public void iniciarControlador() {
		...
		contadorControl = new DadosControl();
		...
		contadorPainelCad.getTB().getPesquisarBtn().setEnabled(false);
		contadorPainelCad.getTB().getRegistrosBtn().setEnabled(false);
	...
	public void iniciarGui() {
		...
		contadorPainelCad = new DadosPainelCad();
