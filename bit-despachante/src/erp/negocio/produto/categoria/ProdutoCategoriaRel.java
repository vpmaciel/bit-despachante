...
public class ProdutoCategoriaRel {
	...
	public ProdutoCategoriaRel(List<ProdutoCategoria> servicos) {

		try {
			writer = PdfWriter.getInstance(document, new FileOutputStream(arquivo));
			relatorio.criarRelatorio(writer, document, titulo);

			for (ProdutoCategoria servico : servicos) {
				document.add(new Paragraph("NOME: " + servico.getNome()));
