...
public class ProdutoMarcaRel {
	...
	public ProdutoMarcaRel(List<ProdutoMarca> produtoMarcas) {

		try {
			writer = PdfWriter.getInstance(document, new FileOutputStream(arquivo));
			relatorio.criarRelatorio(writer, document, titulo);

			for (ProdutoMarca produtoMarca : produtoMarcas) {
				document.add(new Paragraph("NOME: " + produtoMarca.getNome()));
