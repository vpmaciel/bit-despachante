...
public class ProdutoUnidadeRel {
	...
	public ProdutoUnidadeRel(List<ProdutoUnidade> produtoUnidades) {

		try {
			writer = PdfWriter.getInstance(document, new FileOutputStream(arquivo));
			relatorio.criarRelatorio(writer, document, titulo);

			for (ProdutoUnidade produtoUnidade : produtoUnidades) {
				document.add(new Paragraph("NOME: " + produtoUnidade.getNome()));
