...
public final class ServicoJanCad extends JFrame implements Gui {

	private ConfiguracaoGui configuracaoGui;
	private ServicoControl servicoControl;
	private ServicoPainelCad servicoPainelCad;

	public ServicoJanCad() {
		iniciarLayout();
		iniciarGui();
	...
	public ServicoPainelCad getPanelServicoCadastro() {
	...
	public void iniciarGui() {
		...
		servicoPainelCad = new ServicoPainelCad();
